package com.panchuang.manager.model;
...
public class User {
	...
	public User(int id, String name, String gender, float salary) {
		super();
		this.id = id;
		this.name = name;
		this.gender = gender;
	...
	public User(int id, String name, int age, String gender, float salary) {
		super();
		this.id = id;
		this.name = name;
		this.age = age;
